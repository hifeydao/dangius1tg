...
function selectOption(option) {
    ...
    if (option === 'yes') {
        ...
        flashRainbowColors(function() {
            ...
            document.getElementById('haha').classList.add('hidden');

            displayCatHeart(); // Display the cat-heart.gif
        });
    } else if (option === 'no') {
        // Change text on the "No" button to "You sure?"
        document.getElementById('no-button').innerText = 'Huh?'; 
        ...
        document.getElementById('haha').classList.remove('hidden');

    } else {
        // If neither "Yes" nor "No" was clicked, show an alert message
        alert('Baasm ddusng choox ddi');
    }
}
